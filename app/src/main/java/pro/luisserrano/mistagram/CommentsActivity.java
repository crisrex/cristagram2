...
import pro.luisserrano.mistagram.data.adapter.CommonAdapter;
import pro.luisserrano.mistagram.model.Comment;
        ...
        post.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(addcomment.getText().toString().equals( "" )){
                    Toast.makeText( pro.luisserrano.mistagram.CommentsActivity.this,"You can't send empty comment",Toast.LENGTH_SHORT ).show();
                }else {
                    addComment();
                }
            }
