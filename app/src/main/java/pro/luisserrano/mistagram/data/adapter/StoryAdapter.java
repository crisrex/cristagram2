        ...
        holder.itemView.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(holder.getAdapterPosition() == 0){
                    ...
                    Intent intent = new Intent( mContext, pro.luisserrano.mistagram.StoryActivity.class );
                    ...
                    if(count>0) {
                        ...
                        alertDialog.setButton( AlertDialog.BUTTON_POSITIVE, mContext.getString(R.string.add_story),
                                new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent = new Intent( mContext, pro.luisserrano.mistagram.AddStoryActivity.class );
                                        mContext.startActivity( intent );
                                        dialog.dismiss();
                                    }
                                } );
